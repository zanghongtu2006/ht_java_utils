...
/**
 * Created by hongtu on 2016/12/6.
 * ffmpeg 音频转码
 */
...
//        cmd.add("4");//这个是视频质量4就比较高了貌似是最高的,6低,具体几到几我忘了……
    ...
    public static void  main(String [] arg){
        ...
        dto.put("ffmpeg_path", "C:\\Users\\lenovo\\Downloads\\ffmpeg-20161204-1f5630a-win64-static\\bin\\ffmpeg.exe");//必填
//        dto.put("input_path", "E:\\CloudMusic\\徐千雅 - 彩云之南.mp3");//必填
        dto.put("input_path", "E:\\CloudMusic\\output.amr");//必填
        dto.put("video_converted_path", "E:\\CloudMusic\\output.mp3");//必填
//        dto.put("video_converted_path", "E:\\CloudMusic\\output.amr");//必填
//        dto.put("logo", "d\\\\:/ffmpeg/input/logo.png");//可选(注意windows下面的logo地址前面要写4个反斜杠,如果用浏览器里面调用servlet并传参只用两个,如 d:\\:/ffmpeg/input/logo.png)
        String secondsString=  new FFMpegUtil().videoTransfer(dto);
